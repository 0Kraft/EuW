...
if(isset($_POST["setswap"]))
    {
        ...
        $test= exec('curl -s --data-binary \'{"jsonrpc": "2.0", "method": "set_swap", "params": [\'' . $tmp_var . '\'], "id": 0}\' -H \'Accept:\' 127.0.0.1:31415');
    }
    
if(isset($_POST["cv"]))
    {
        $test= exec('curl -s --data-binary \'{"jsonrpc": "2.0", "method": "cv", "id": 0}\' -H \'Accept:\' 127.0.0.1:31415');
    }
    
if(isset($_POST["shot"]))
    {
        $test= exec('curl -s --data-binary \'{"jsonrpc": "2.0", "method": "shot", "id": 0}\' -H \'Accept:\' 127.0.0.1:31415');
    }
