...
def get_orientation():
    ...
    if lines.size:
        ...
        for rho,theta in lines[0]:
                        ...
                        cv2.line(thresh_im,(x1,y1),(x2,y2),(255,255,255),2)
        ...
        cv2.putText(thresh_im, str(course) ,(10,140), cv2.FONT_HERSHEY_SIMPLEX, 1,(255,255,255),2)

        cv2.imwrite( "final.jpg", thresh_im )
